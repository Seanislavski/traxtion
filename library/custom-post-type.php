...
//End Sean's Blog Type
*/
//Start Sean's Classes Type

add_action('init', 'cptui_register_my_cpt_classes');
function cptui_register_my_cpt_classes(//http://codex.wordpress.org/Function_Reference/register_post_type
)
{
...
function custom_post_example() { 
	...
	*/
	/* Sean's Custom Taxonomy */
	/*
		register_taxonomy( 'class', 
		array('custom_type'), // if you change the name of register_post_type( 'custom_type', then you have to change this 
		array('hierarchical' => true,     // if this is true, it acts like categories 
			'labels' => array(
				'class' => __( 'Custom Categories', 'bonestheme' ), // name of the custom taxonomy 
				'class' => __( 'Custom Category', 'bonestheme' ), // single taxonomy name 
